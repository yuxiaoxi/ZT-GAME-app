...
package com.example.zt_game_app.utils.timeview;
...
import com.example.zt_game_app.utils.timeview.MonthCellDescriptor.RangeState;
...
public class CalendarPickerView extends ListView {
  ...
  public CalendarPickerView(Context context, AttributeSet attrs) {
    ...
    headerTextColor =
        a.getColor(R.styleable.CalendarPickerView_headerTextColor_time, R.color.calendar_text_active);
    a.recycle();
